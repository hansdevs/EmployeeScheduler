...
function getEmployeeColor(empId){
    ...
    /* JACOBS JOB */
  // Jacob do you want to do an actual lookup from the server:
  // Option 1: store an array of employees in a script tag
  // Option 2: call an API
  // Option 3: change this to whatever you see fits.
  // For demonstration, read from the row’s "color_class" attribute or something similar:
  // (In a real scenario, we might have to: <tr data-employee-color="{{ emp.color_class }}">)
